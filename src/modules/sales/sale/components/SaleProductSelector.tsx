...
interface SaleProductSelectorProps {
    ...
    onAddProduct: (product: SaleProductRequest) => void;

}

export default function SaleProductSelector({
    ...
    function handleAdd() {
        ...
        if (!productId) {
            ...
            setToastMessage("Seleccione un producto.");
        ...
        if (quantity <= 0) {
            ...
            setToastMessage("La cantidad debe ser mayor que cero.");
